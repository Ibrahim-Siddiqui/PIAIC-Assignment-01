...
let uppercaseName: string = "ibrahim ahmed siddiqui".toUpperCase();
let lowercaseName: string = "IBRAHIM AHMED SIDDIQUI".toLowerCase();
let titlecaseName:string = "Ibrahim Ahmed Siddiqui";
